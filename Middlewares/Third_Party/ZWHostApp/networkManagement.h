...
BYTE NetworkManagement_NH_TestConnection(BYTE bNodeID, void (*CompletedFunc)(BYTE bStatus, WORD wTime));
...
BYTE NetworkManagement_ZW_SendData(BYTE bNodeID, BYTE *pData, BYTE bDataLength, void (__cdecl *completedFunc)(BYTE, WORD));
